   ...
   <div class="br-tab">
               ...
               <div class="d-flex flex-row justify-content-center col-lg-12">
                  ...
                  @foreach($cat_evento as $categoria)
                     ...
                     <div class="tab-item col-md-3">
                        <button class="br-card col-lg-12 mr-5 mt-3 text-center" style="background-color: white;" data-panel="evento_{{$categoria->categoria_id}}">
                           <div class="card-content">
      ...
      <h2 class="text-center text-weight-semi-bold mt-6 pt-3">Inscrições Abertas</h2>      
         ...
         <div class="tab-content container-lg mb-6 mt-6">
            ...
            <div  class="tab-panel" id="evento_1">
               <div class="pl-sm-3 ">
                  <div class="row mt-5">
                     @foreach($eventos as $evento)
            ...
            <div class="tab-panel" id="evento_2">
               <div class="pl-sm-3 ">
                  <div class="row mt-5">
                     @foreach($eventos as $evento)
            ...
            <div class="tab-panel" id="evento_3">
               <div class="pl-sm-3 ">
                  <div class="row mt-5">
                     @foreach($eventos as $evento)
