<div id="kt_header" class="header align-items-stretch">
    ...
    <div class="header-brand">
        ...
        <a href="{{ route ('painel.home') }}">
            <img alt="Logo" src="{{ url ('assets/imagens/logo.png') }}" class="h-45px h-lg-45px" /> <font size="5" color="white"><b>&nbsp;&nbsp;SGE</b></font>
        </a>
        <!--end::Logo-->
    ...
    <div class="toolbar">
        ...
        <div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
            ...
            <div class="page-title d-flex flex-column me-5">
                <!--begin::Title-->
                <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">SGE</h1>
                <!--end::Title-->
                ...
                @if(Auth::user()->perfil_id != 1)
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route ('painel.home') }}" class="text-muted text-hover-primary">Home</a>
                        </li>
                        <!--end::Item-->
