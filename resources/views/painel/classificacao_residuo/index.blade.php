...
<div id="kt_content" class="content d-flex flex-column flex-column-fluid">
    ...
    <div id="kt_post" class="post d-flex flex-column-fluid">
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">Classificação de Resíduo</span>
                        <span class="text-muted mt-1 fw-bold fs-7">Cadastro de Classificações de Resíduo</span>
                    </h3>
                    <div class="card-toolbar">
                        ...
                        <a href="#" class="btn btn-sm btn-light-primary" data-bs-toggle="modal" data-bs-target="#modal_cadastro">
                            ...
                            <!--end::Svg Icon-->Nova Classificação
                        </a>
                                ...
                                <tr id="tr_{{ $classificacao->id }}">
                                    ...
                                    <td class="ps-4">
                                        <a href="#" onClick="return abrirModalEditar({{ $classificacao->id }});" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6" data-bs-toggle="modal" data-bs-target="#modal_editar">
                                            <div id="celula_nome_{{ $classificacao->id }}">{{ $classificacao->nome }}</div>
                                        </a>
                                    </td>
                                    ...
                                    <td>
                                        <div id="celula_exige_mtr_{{ $classificacao->id }}">
                                            @if($classificacao->exige_mtr)
                                    ...
                                    <td>
                                        <div id="celula_exige_cadri_{{ $classificacao->id }}">
                                            @if($classificacao->exige_cadri)
                                            <span class="badge badge-success">Sim</span>
                                            @else
                                            <span class="badge badge-secondary">Não</span>
                                            @endif
                                    ...
                                    <td class="text-end">
                                        <div class="card-toolbar">
                                            <a href="#" class="btn btn-sm btn-light-primary" onClick="return abrirModalEditar('{{ $classificacao->id }}');" data-bs-toggle="modal" data-bs-target="#modal_editar">
                                                <!--begin::Svg Icon-->
                                                <span class="svg-icon svg-icon-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                            ...
                                            <button type="button" class="btn btn-sm btn-light-danger" onClick="return excluir('{{ $classificacao->id }}');">
                                                <!--begin::Svg Icon-->
                                                <span class="svg-icon svg-icon-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            @include('painel.classificacao_residuo.criar')
            @include('painel.classificacao_residuo.editar')
...
@include('painel.classificacao_residuo.js')
