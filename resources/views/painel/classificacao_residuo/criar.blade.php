    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2>Adicionar Nova Classificação de Resíduo</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form class="form" id="form_cadastro" action="#">
                    ...
                    <div class="d-flex flex-column mb-7 fv-row">
                        ...
                        <input type="text" class="form-control form-control-solid" name="codigo" id="codigo"/>
                    </div>
                    <!--end::Input group-->
