            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    <div class="card-title flex-column col-8 ">
                        ...
                        <div>
                            <span class="card-label fw-bolder fs-3 mb-1" style="width:20%">Relação de Inscritos com Dados Pessoais:</span>
                    ...
                    <div class="card-toolbar">
                        @if (sizeof($inscritos))
                        <div class="p-2">
                            <a class="btn btn-sm btn-light-danger" onclick="exportarPdfInscristosDadosPessoais({{$eventos->id}})">
                        ...
                        <div class="p-2">
                            <a onclick="exportarExcelInscristosDadosPessoais({{$eventos->id}})" class="btn btn-sm btn-light-success">
                                <span class="svg-icon svg-icon-2">
                        ...
                        <table id="tabela" class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                            ...
                            <thead>
                                <tr class="fw-bolder text-muted bg-secondary">
                                    ...
                                    <th class="ps-4 min-w-200px">Tipo Pessoa</th>
                                    <th class="ps-4 min-w-200px">Telefone</th>
                                    <th class="ps-4 min-w-200px">E-mail</th>
                                    <th class="min-w-200px text-start rounded-end">Presença</th>
                                </tr>
                            </thead>
                            <!--end::Table head-->
                            <!--begin::Table body-->
                                ...
                                <tr id="tr_{{-- $categoria_eventos->id --}}">
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">
                                            ...
                                            <div>
                                                {{ $inscrito->tipo_pessoa }}
                                            </div>
                                        </a>
                                    </td>

                                    <td><a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">
                                            <div> {{ $inscrito->telefone }}</div>
                                        </a>
                                    </td>
