                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    ...
                    <form class="form" action="#">
                        ...
                        <div class="d-flex flex-column mb-7 fv-row">
                            ...
                            <input type="text" class="form-control form-control-solid" id="name_edit" name="name_edit"/>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="d-flex flex-column mb-7 fv-row">
                            ...
                            <select class="form-control form-control-solid" id="perfil_edit" name="perfil_edit">
